...
@export var standardRange: float
@export var AOERange: float
@export var specialRange: float

@export var attackCooldown: float
@export var standardDamage: int
#@export var MeleeDamage: int
@export var AOEDamage: int
@export var specialDamage: int

signal Hit
signal WalkCommand
signal StandardAttackCommand # Close range attack
...
func set_target(target):
	StandardAttackCommand.emit(target)
